...
"""Module RPNHGrid contains the classes used to manipulate RPN style Horizontal Grid definition
...
class RPNHGgrid(RPNBaseDict):
    """RPN Horizontal Grid container class.
    Hold Horizontal Grid definiton and methods to interact with it
