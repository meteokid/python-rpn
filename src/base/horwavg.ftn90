...
!
      subroutine horwavg ( F_avg_8, F_in1, F_in2, Minx,Maxx,Miny,Maxy )
!
      implicit none
...
!
      ...
      real*8 F_avg_8
      real F_in1(Minx:Maxx,Miny:Maxy), F_in2(Minx:Maxx,Miny:Maxy)
!
!author 
...
!     ---------------------------------------------------------------
!
      call glbcolc (wk1,G_ni,G_nj,F_in1,Minx,Maxx,Miny,Maxy,1)
      call glbcolc (wk2,G_ni,G_nj,F_in2,Minx,Maxx,Miny,Maxy,1)
!
