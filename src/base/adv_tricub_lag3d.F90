...
!---------------------------------- LICENCE END ---------------------------------
      ...
      subroutine adv_tricub_lag3d (F_cub, F_mono, F_lin, F_min, F_max  , &
                                   F_in, F_x, F_y, F_z, F_num, F_mono_L, &
                                   F_conserv_L, i0, in, j0, jn, k0     , &
                                   F_nk, F_lev_S)
      implicit none
...
#include "glb_ld.cdk"
      ...
      integer :: n,i,j,k,ii,jj,kk,iL,kkmax,idxk,idxjk,o1,o2,o3,o4
      real :: prmin, prmax
      real*8 :: a1, a2, a3, a4  , &
              b1, b2, b3, b4, c1, c2, c3, c4, &
              d1, d2, d3, d4, p1, p2, p3, p4, &
              rri,rrj,rrk,ra,rb,rc,rd, prf1,prf2,&
              capx,capy,capz,triprd,za,zb,zc,zd,p_z00_8
