...
!---------------------------------- LICENCE END ---------------------------------
!**s/r int_cubgeo_lag - to do YY cubic interpolation for scalar fields


       Subroutine int_cub_geo(FF,F,Imx,Imy,Ni,Nj,Xi,Yi,x_8,y_8) 
...
#include "glb_ld.cdk"
       ...
       real*8 F(Ni,Nj),fx1,fx2,fx3,fx4
       real*8 Xi,Yi,x_8(*),y_8(*)
