...
!
     ...
     do kk=1,Ptopo_numproc
        ...
        if (send_len(kk).gt.0) Bln_usendmaxproc=Bln_usendmaxproc+1
        if (recv_len(kk).gt.0) Bln_urecvmaxproc=Bln_urecvmaxproc+1
     enddo
