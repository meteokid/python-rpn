...
#include "adx_dims.cdk"
   ...
   !-----------------------------------------------------------------------
   if (ILMC_L.and.     Adx_yinyang_L) call ILMC_GY (F_name_S,F_mono,F_cub,F_min,F_max,Minx,Maxx,Miny,Maxy,F_nk,k0) 
   if (ILMC_L.and..not.Adx_yinyang_L) call ILMC_GU (F_name_S,F_mono,F_cub,F_min,F_max,Minx,Maxx,Miny,Maxy,F_nk,k0) 
