...
#include <msg.h>
   ...
   !@public_functions
   public :: drv_time_config, drv_time_init, drv_time_info, drv_time_increment,drv_time_shuffle_name,drv_time_shuffle,drv_time_shuffle_list
   !@public_vars
   character(len=15), public :: time_run_start !- YYYYMMDD.hhmmss
   real(RDOUBLE), public,save :: time_dt       !- time step [sec]
...
contains
   ...
   !*@/
      ...
      write(msg_S,'("Step=",i4.4," (datev=",a,") (ckpt,last,stat)=(",l2,l2,l2,")")') F_stepno,datev_S(1:15),F_is_chkpt_L,F_is_last_L,is_stat_L
   ...
   !/@*
   subroutine drv_time_info(F_stepno,F_is_chkpt_L,F_is_last_L,F_is_stat_L,F_datev,F_dateo,F_dt,F_nb_time_levels,F_swap_mode)
      implicit none
      !@objective Increase time step and update GMM fields names
      !@arguments
