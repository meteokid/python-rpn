...
!!$         ip1(1) = ip1_m(l_nk)
         ...
         if (RMN_IS_OK(F_istat)) then
            ...
            write(tmp_S,'(a,i3,a,i3,a,i9,a,i9,a,i9,a,i9)') '(drv_levels) ip1_m(',i0,':',in,')=', ip1mt(1),', ', ip1mt(2),', ...,', ip1mt(3),', ', ip1mt(4)
            ...
            write(tmp_S,'(a,i3,a,i3,a,i9,a,i9,a,i9,a,i9)') '(drv_levels) ip1_t(',i0,':',in,')=', ip1mt(1),', ', ip1mt(2),', ...,', ip1mt(3),', ', ip1mt(4)
            call msg(MSG_INFO,tmp_S)
            ...
            write(tmp_S,'(a,i3,a,i3,a,f10.2,a,f10.2,a,f10.2,a,f10.2)') '(drv_levels) std_p_prof_m(',i0,':',in,')=', r14(1),', ', r14(2),', ...,', r14(3),', ', r14(4)
            call msg(MSG_INFO,tmp_S)
         endif
         ...
         if (RMN_IS_OK(F_istat)) then
            ...
            r14(1) = std_p_prof(i0) ; r14(2) = std_p_prof(i1)
            r14(3) = std_p_prof(in1) ; r14(4) = std_p_prof(in)
            write(tmp_S,'(a,i3,a,i3,a,f10.2,a,f10.2,a,f10.2,a,f10.2)') '(drv_levels) std_p_prof_t(',i0,':',in,')=', r14(1),', ', r14(2),', ...,', r14(3),', ', r14(4)
            call msg(MSG_INFO,tmp_S)
         endif
         if (associated(std_p_prof)) deallocate(std_p_prof,stat=istat)
