...
contains
   ...
   !*@/
      ...
      if (RMN_IS_OK(F_istat)) then
         write(tmp_S,'(4(A,2I6),a,2l,a)') '(drv_grid) Initialization OK: [G_ni,G_nj=',G_ni,G_nj,"] [l_ni,l_nj=",l_ni,l_nj,"] [l_i0,l_j0=",l_i0,l_j0,"] [hx,hy=",G_halox,G_haloy,"] [periodx,y=",G_periodx,G_periody,"]"
!!$      call msg(MSG_INFO,tmp_S)
      ...
      istat = hgrid_wb_put('full+h',G_grid_id,1+hx,1+hy,G_ni,G_nj,hx,hy,F_periodX=iperiodx,F_periodY=iperiody)
      istat = hgrid_wb_put('local#+h',G_grid_id,l_i0+hx,l_i0+hy,l_ni,l_nj,hx,hy,F_dieze=HGRID_DIEZE,F_periodX=iperiodx,F_periodY=iperiody)
      ...
      hx=0 ; hy=0 ; i0=1 ; j0=1
      istat = hgrid_wb_put('full',grid_id2,i0,j0,G_ni,G_nj,hx,hy,F_periodX=iperiodx,F_periodY=iperiody)
      istat = hgrid_wb_put('local#',grid_id2,l_i0+hx,l_j0+hx,l_ni,l_nj,hx,hy,F_dieze=HGRID_DIEZE,F_periodX=iperiodx,F_periodY=iperiody)
