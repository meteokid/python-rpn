Global Environmental Multi-scale model (GEM): RPN, MRD, STB, ECCC, GC, CA
=========================================================================

This document is intended as a notebook and checklist for the GEM
...
Use the following Makefile targets to compile the build abs.  
...
To remove all files created by the setup, compile and build process, use the `distclean` target.
        ...
        make distclean
        rm -rf .rde.linkdir ssmusedep*.bndl ATM_MODEL_*
