...
#include "path.cdk"
      ...
      character*12  lab
      character*15  pdate
      integer,external :: e_pilotf2, fnom, fstouv, fstinf, fstprm, fstfrm
...
!
      ...
      if (err .ge. 0) then
         ...
         if (key.ge.0) then
            key = fstprm ( key, dte, det, ipas, ni1,nj1,nk1, bit, dty, &
                           p1,ip2a,ip3a, typ,var,lab,grd, g1,g2,g3,g4, &
                           swa,lng, dlf, ubc, ex1, ex2, ex3 )
            write (6,2004) F_nomvar_S, pdate
         else
            err = fstfrm(F_unit)
            call fclos  (F_unit)
            F_unit= -1
            write (6,2005) F_nomvar_S, pdate
         endif
      endif
      e_fstouv = min(0,key)

 2003 format (/' E_FSTOUV:  file ',a,' open on unit: ',i4)
 2004 format (12x,'found variable ',a, ' valid ',a)
 2005 format (12x,'variable ',a, ' valid ',a, ' NOT found')
