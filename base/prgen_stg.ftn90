...
!
      subroutine prgen_stg (F_out,F_in_top,F_in,F_in_bot,F_deriv, &
           ...
           F_pres, Nkout, F_cubic_L, Minx,Maxx,Miny,Maxy, Nk)
!
      implicit none
#include <arch_specific.hf>
!
      integer Minx,Maxx,Miny,Maxy,Nk,Nkout
      logical F_cubic_L
      real    F_pres(Nkout), F_out(Minx:Maxx,Miny:Maxy,Nkout), &
              F_in_top(Minx:Maxx,Miny:Maxy),F_in(Minx:Maxx,Miny:Maxy,Nk), &
              F_in_bot(Minx:Maxx,Miny:Maxy),F_deriv(Minx:Maxx,Miny:Maxy,Nk), &
              F_wlnph_top(Minx:Maxx,Miny:Maxy),F_wlnph(Minx:Maxx,Miny:Maxy,Nk), &
              F_wlnph_bot(Minx:Maxx,Miny:Maxy)
!
!author
