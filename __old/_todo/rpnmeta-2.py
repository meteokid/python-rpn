...
class RPNMeta(BaseMeta):
    """RPN standard file meta descriptors class.
    Hold record metata, needed to write a record, can be used for search.
    ...
    >>> d.sort()
    >>> d
    [('dateo', -1), ('datyp', -1), ('deet', -1), ('etiket', '            '), ('grtyp', ' '), ('ig1', -1), ('ig2', -1), ('ig3', -1), ('ig4', -1), ('ip1', -1), ('ip2', -1), ('ip3', -1), ('nbits', -1), ('nom', '    '), ('npas', -1), ('type', '  ')]
    >>> myRPNMeta = RPNMeta({'nom':'GZ  ','ip2':1})  #New RPNMeta with all descriptors to wildcard but nom,ip2
    >>> d = myRPNMeta.items()
    >>> d.sort()
    >>> d
    [('dateo', -1), ('datyp', -1), ('deet', -1), ('etiket', '            '), ('grtyp', ' '), ('ig1', -1), ('ig2', -1), ('ig3', -1), ('ig4', -1), ('ip1', -1), ('ip2', 1), ('ip3', -1), ('nbits', -1), ('nom', 'GZ  '), ('npas', -1), ('type', '  ')]
    >>> myRPNMeta['ip1']
    -1
    ...
    >>> myRPNMeta['nom'] = 'TT  '
    >>> myRPNMeta2 = RPNMeta(myRPNMeta)   #make a deep-copy
    >>> myRPNMeta2.update({'nom':'GZ  ','ip2':8}) #update nom,ip2 values
...
class RPNMeta0(RPNKeys,RPNDesc):
