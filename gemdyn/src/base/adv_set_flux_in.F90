!**s/p adv_set_flux_in - Set F_in_o/F_in_i for Flux calculations based on Aranami et al. (2015)  

subroutine adv_set_flux_in (F_in_o,F_in_i,F_rho,Minx,Maxx,Miny,Maxy,F_nk,k0)
