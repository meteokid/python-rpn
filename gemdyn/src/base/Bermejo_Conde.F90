!**s/p Bermejo_Conde - Ensures conservation of interpolated field (Bermejo and Conde,2002)
      ...
      ! v4_87 - Tanguay M.        - Provide air mass to mass_tr
      !Object
...
#include "schm.cdk"
      ...
      if (Schm_psadj==0.and..NOT.LAM_L.and..NOT.Schm_autobar_L) call handle_error(-1,'BERMEJO-CONDE','Schm_psadj should be > 0 when NOT LAM')
