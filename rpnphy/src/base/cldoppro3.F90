...
!
!
!...   choice of effective radius for liquid clouds
!...   ioptrew=1 : as in newrad - from h. barker, based on aircraft data, range 4-17 micron from slingo
!...   ioptrew=2 : as in newrad - corresponds to so called new optical properties
!...   ioptrew=3 : from Rotstayn and Liu (2003)
!
!
        ...
        do k = 1, nk
          do i = 1, lmx
             vs1(i,k) = (1.0 + liqwcin(i,k) * 1.e4) &
                         * liqwcin(i,k) * aird(i,k) * rec_cdd(i,k)
          enddo
        enddo
        call vspown1(rew, vs1,third, nk * lmx)
!
...
!
!...   choice of effective radius for ice clouds
!...   ioptrei=1 : from cccma
!...   ioptrei=2 : as in newrad - constant of 15 microns
!
!
...
!
      ...
      elseif (ioptrei .eq. 2)                                       then
        ...
        if (stcond=='MP_MY2' .or. stcond=='MP_P3') then
           rei = 30.
        else
           rei = 15.
        endif
