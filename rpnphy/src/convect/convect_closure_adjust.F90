...
REAL_B, DIMENSION(KLON),      INTENT(IN) :: PADJ     ! mass adjustment factor


REAL_B, DIMENSION(KLON,KLEV), INTENT(INOUT) :: PUMF  ! updraft mass flux (kg/s)
REAL_B, DIMENSION(KLON,KLEV), INTENT(INOUT) :: PZUMF ! initial value of  "
REAL_B, DIMENSION(KLON,KLEV), INTENT(INOUT) :: PUER  ! updraft entrainment (kg/s)
REAL_B, DIMENSION(KLON,KLEV), INTENT(INOUT) :: PZUER ! initial value of  "
REAL_B, DIMENSION(KLON,KLEV), INTENT(INOUT) :: PUDR  ! updraft detrainment (kg/s)
REAL_B, DIMENSION(KLON,KLEV), INTENT(INOUT) :: PZUDR ! initial value of  "
REAL_B, DIMENSION(KLON,KLEV), INTENT(INOUT) :: PDMF  ! downdraft mass flux (kg/s)
REAL_B, DIMENSION(KLON,KLEV), INTENT(INOUT) :: PZDMF ! initial value of  "
REAL_B, DIMENSION(KLON,KLEV), INTENT(INOUT) :: PDER  ! downdraft entrainment (kg/s)
REAL_B, DIMENSION(KLON,KLEV), INTENT(INOUT) :: PZDER ! initial value of  "
REAL_B, DIMENSION(KLON,KLEV), INTENT(INOUT) :: PDDR  ! downdraft detrainment (kg/s)
REAL_B, DIMENSION(KLON,KLEV), INTENT(INOUT) :: PZDDR ! initial value of  "
REAL_B, DIMENSION(KLON),   INTENT(INOUT):: PTPR     ! total precipitation (kg/s)
REAL_B, DIMENSION(KLON),   INTENT(INOUT):: PZTPR    ! initial value of "
REAL_B, DIMENSION(KLON),   INTENT(INOUT):: PDTEVR   ! donwndraft evapor. (kg/s)
REAL_B, DIMENSION(KLON),   INTENT(INOUT):: PZDTEVR  ! initial value of "
REAL_B, DIMENSION(KLON),   INTENT(INOUT):: PPRMELT  ! melting of precipitation
REAL_B, DIMENSION(KLON),   INTENT(INOUT):: PZPRMELT ! initial value of "
REAL_B, DIMENSION(KLON,KLEV),INTENT(INOUT)  :: PPRLFLX! liquid precip flux
REAL_B, DIMENSION(KLON,KLEV),INTENT(INOUT)  :: PZPRLFL! initial value "
REAL_B, DIMENSION(KLON,KLEV),INTENT(INOUT)  :: PPRSFLX! solid  precip flux
REAL_B, DIMENSION(KLON,KLEV),INTENT(INOUT)  :: PZPRSFL! initial value "


!*       0.2   Declarations of local variables :

INTEGER_M :: IIE, IKB, IKE                 ! horiz. + vert. loop bounds
INTEGER_M :: JK                            ! vertical loop index
