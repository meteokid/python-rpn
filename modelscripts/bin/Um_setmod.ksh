...
geophy=${default_DIR_ATM}/geophy
climato=${default_DIR_ATM}/climato

PREP_dir=${PWD}/PREP/output/${rep2cfg}
PHYTB=${rpnphy}/include/physics_input_table_GENERIC
...
while [ $domain_number -le $DOMAIN_end ] ; do
  ...
  tskcfg -rep2cfg ${dname} -gem_cfgfile $CFGFILE \
         -nml ${dircfg}/${dname}/gem_settings.nml -out_cfg $OUTCFG          \
