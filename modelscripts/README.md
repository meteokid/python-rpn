Model Infrastructure Group (MIG) support scripts: RPN, MRD, STB, ECCC, GC, CA
=============================================================================

This document is intended as a notebook and checklist for the ModelScripts
...
**To Do ONLY on the Front End Machine**
        ...
        MYVERSION=5.1.a6  ## Obviously, you'll need to change this to the desired version
        NAME=modelscripts
