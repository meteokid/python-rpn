ifneq (,$(DEBUGMAKE))
$(info ## ====================================================================)
$(info ## File: $$modelscripts/Makefile.user.mk)
$(info ## )
endif
#VERBOSE=1
...
COMPONENTS        := modelscripts
COMPONENTS_UC     := $(foreach item,$(COMPONENTS),$(call rdeuc,$(item)))
COMPONENTS_VFILES := $(foreach item,$(COMPONENTS_UC),$($(item)_VFILES))

#------------------------------------

MYSSMINCLUDEMK = $(wildcard $(MODELSCRIPTS_INCLUDE0)/Makefile.ssm.mk $(modelscripts)/include/Makefile.ssm.mk)
...
#------------------------------------
ifeq (-d,$(MODELSCRIPTS_BUILDDIR_SFX))
COMP_RULES_FILE = $(MODELSCRIPTS_COMP_RULES_DEBUG)
#ifeq (intel13sp1u2,$(CONST_MODELSCRIPTS_COMP_ARCH))
...
$(info COMPONENTS_UC=$(COMPONENTS_UC))
$(info COMPONENTS_SSM_ALL=$(COMPONENTS_SSM))
